...
__all__ = ["NIRISS", "NIRCam", "NIRCamOld"]
...
class NIRCam(JWST):
    ...
    def _construct_optics(
        ...
        det_pscale = dlu.arcsec_to_rad(self.pixelscale.value / osamp)

        layers.append(dl.MFT(det_npix, det_pscale))
...
class NIRCamOld(dl.instruments.Instrument):
